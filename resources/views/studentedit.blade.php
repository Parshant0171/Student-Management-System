    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_content">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                <input  name="class" value="{{$students->class}}" id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="middle-name">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                <input name="email" value="{{$students->email}}" id="birthday" class="date-picker form-control col-md-7 col-xs-12" required="required" type="text">
                </div>
            </div>
